...
const TABS: { href: string; label: string; icon: React.ReactNode }[] = [
  ...
  { href: "/prayer", label: "기도", icon: <><circle cx="12" cy="9" r="4" /><path d="M8 15l4 6 4-6" /></> },
  { href: "/calendar", label: "일정", icon: <><rect x="3" y="5" width="18" height="16" rx="1.5" /><line x1="3" y1="10" x2="21" y2="10" /><line x1="8" y1="3" x2="8" y2="7" /><line x1="16" y1="3" x2="16" y2="7" /></> },
