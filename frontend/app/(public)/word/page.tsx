            ...
            {!gospel ? (
              ...
              <>
                ...
                {gospel.readings.gospel && (
                  <article id="gospel" className="scroll-mt-32 bg-[var(--color-text)] text-white rounded-2xl p-7 sm:p-10 mb-5">
...
function ReadingCard({
  ...
  return (
    <article
      id={id}
      className="scroll-mt-32 bg-white border border-[var(--color-border)] rounded-2xl p-7 sm:p-10 mb-5"
    >
