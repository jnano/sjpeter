...
export default function AdminParishMassTimesPage() {
  ...
  return (
    <div className="p-8 max-w-3xl mx-auto">
      <div className="mb-6">
        <h1 className="text-2xl font-bold">미사 시간</h1>
        <p className="text-sm text-gray-500 mt-1">주일·평일·공휴일 미사 시간과 안내 메모를 관리합니다.</p>
      </div>
