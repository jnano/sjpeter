...
const CHANGELOG: { version: string; date: string; tag: Tag; items: string[] }[] = [
  ...
  },
  {
    ...
    items: [
      "라벨 일관성 정리 — '본당 가족'·특정 본당명 하드코딩 제거",
      ...
      "  · 특정 본당명 16건 → site_settings.PARISH_NAME 동적 참조 또는 일반화. build_pptx.py 는 site_settings → env var 폴백 추가",
