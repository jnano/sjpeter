...
POSTS = [
    ...
    ("성지 순례 — 베타니아 성지",
     "신자분들 80여 명이 함께 떠난 베타니아 성지 순례. 십자가의 길을 함께 걸으며 마음을 나눈 하루였습니다."),
    ("야외 미사 — 봄꽃이 핀 성당 정원에서",
    ...
    ("성가대 정기 연주회",
     "한 해 동안 갈고닦은 성가를 신자분들 앞에서 봉헌한 성가대 정기 연주회. 성가대원들의 땀이 빛났습니다."),
    ...
    ("성지 답사 — 다음 순례를 위한 사전 답사",
     "본당 단체 순례를 위해 봉사자들이 미리 다녀온 성지 답사. 길과 식당, 화장실까지 꼼꼼히 점검했습니다."),
    ("본당 도서관 개관식",
     "신앙 서적을 모은 본당 도서관 개관식. 신부님께서 축복 기도를 봉헌해 주셨습니다."),
    ("새 사제관 입주 축하",
     "본당 사제관 새 단장 후 입주를 축하하며 모인 자리. 신자들이 정성껏 준비했습니다."),
    ("부활 달걀 나누기",
     "부활 미사 후 본당 마당에서 어린이들에게 부활 달걀을 나눠 주었습니다. 작은 기쁨이 가득했습니다."),
    ("성탄 트리 점등식 — 본당 마당의 빛",
     "대림 첫 주일 저녁, 본당 마당의 큰 트리에 불이 켜졌습니다. 신자들이 둘러서서 함께 박수쳤습니다."),
    ("봄맞이 환경 정화 — 본당 주변 청소",
     "신자들이 함께 모여 본당 주변 거리와 공원을 청소했습니다. 이웃에게 드리는 작은 선물이었습니다."),
    ("가을 본당 정원 가꾸기",
     "본당 정원의 묵은 잎을 거두고 새로 화단을 다듬은 봉사 시간. 흙 묻은 손이 정겨웠습니다."),
    ("신부님 환송 미사 — 감사한 7년",
     "본당에 7년을 함께해 주신 신부님 환송 미사. 신자분들 모두가 마지막 인사를 드렸습니다."),
    ("새 신부님 환영 — 첫 미사 후 인사",
     "새로 부임하신 신부님의 첫 주일 미사 후 신자분들이 줄을 서서 인사를 드렸습니다."),
